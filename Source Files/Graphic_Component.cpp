...
Graphic_Component::Graphic_Component(Transform_Component* transform_component,
	const Texture_Storage* texture_storage, std::string texture_file, const SDL_Rect& camera) 
...
{
	destination_rect.x = transform_component_->position_.x - camera_.x;
	destination_rect.y = transform_component_->position_.y - camera_.y;
